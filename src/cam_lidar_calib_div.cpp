...
private:
    ...
    ros::Publisher cloud_pub_filter_x;
    ros::Publisher cloud_pub_filter_y;
    ros::Publisher cloud_pub_filter_z;
...
public:
    ...
    camLidarCalib(ros::NodeHandle n) {
        ...
        cloud_pub_filter_x = nh.advertise<sensor_msgs::PointCloud2>("points_out_filter_x", 1);
        cloud_pub_filter_y = nh.advertise<sensor_msgs::PointCloud2>("points_out_filter_y", 1);
        cloud_pub_filter_z = nh.advertise<sensor_msgs::PointCloud2>("points_out_filter_z", 1);
...
//        ROS_INFO_STREAM("No of planar_pts: " << lidar_points.size());
       ...
       sensor_msgs::PointCloud2 out_cloud_filter_x;
       pcl::toROSMsg(*cloud_filtered_x, out_cloud_filter_x);
       out_cloud_filter_x.header.frame_id = cloud_msg->header.frame_id;
       out_cloud_filter_x.header.stamp = cloud_msg->header.stamp;
       cloud_pub_filter_x.publish(out_cloud_filter_x);

       sensor_msgs::PointCloud2 out_cloud_filter_y;
       pcl::toROSMsg(*cloud_filtered_y, out_cloud_filter_y);
       out_cloud_filter_y.header.frame_id = cloud_msg->header.frame_id;
       out_cloud_filter_y.header.stamp = cloud_msg->header.stamp;
       cloud_pub_filter_y.publish(out_cloud_filter_y);

       sensor_msgs::PointCloud2 out_cloud_filter_z;
       pcl::toROSMsg(*cloud_filtered_z, out_cloud_filter_z);
       out_cloud_filter_z.header.frame_id = cloud_msg->header.frame_id;
       out_cloud_filter_z.header.stamp = cloud_msg->header.stamp;
       cloud_pub_filter_z.publish(out_cloud_filter_z);
